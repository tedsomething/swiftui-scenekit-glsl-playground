...
vec3 color1 = vec3(0.0, 0.652832, 0.083156); // Green
vec3 color2 = vec3(0.0177, 0.399886, 0.161979); // Green Blue
vec3 color3 = vec3(0.407237, 0.955974, 0.396755); // Light Green
vec3 color4 = vec3(0.121466, 0.178765, 1.0); // Blue
